...
import power.keepeersofthestones.potion.TimeDilationEffectMobEffect;
...
public class PowerModMobEffects {
	...
	public static final RegistryObject<MobEffect> RECHARGE_FIRE_STONE = REGISTRY.register("recharge_fire_stone", () -> new RechargeFireStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_WATER_STONE = REGISTRY.register("recharge_water_stone", () -> new RechargeWaterStoneMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_EARTH_STONE = REGISTRY.register("recharge_earth_stone", () -> new RechargeEarthStoneMobEffect());
	public static final RegistryObject<MobEffect> ENERGY_MASTER = REGISTRY.register("energy_master", () -> new EnergyMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_ENERGY_STONE = REGISTRY.register("recharge_energy_stone", () -> new RechargeEnergyStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_LIGHTNING_STONE = REGISTRY.register("recharge_lightning_stone", () -> new RechargeLightningStoneMobEffect());
	public static final RegistryObject<MobEffect> SOUND_MASTER = REGISTRY.register("sound_master", () -> new SoundMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_SOUND_STONE = REGISTRY.register("recharge_sound_stone", () -> new RechargeSoundStoneMobEffect());
	public static final RegistryObject<MobEffect> CRYSTAL_MASTER = REGISTRY.register("crystal_master", () -> new CrystalMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_CRYSTAL_STONE = REGISTRY.register("recharge_crystal_stone", () -> new RechargeCrystalStoneMobEffect());
	public static final RegistryObject<MobEffect> LAVA_MASTER = REGISTRY.register("lava_master", () -> new LavaMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_LAVA_STONE = REGISTRY.register("recharge_lava_stone", () -> new RechargeLavaStoneMobEffect());
	public static final RegistryObject<MobEffect> RAIN_MASTER = REGISTRY.register("rain_master", () -> new RainMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_RAIN_STONE = REGISTRY.register("recharge_rain_stone", () -> new RechargeRainStoneMobEffect());
	public static final RegistryObject<MobEffect> TORNADO_MASTER = REGISTRY.register("tornado_master", () -> new TornadoMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_TORNADO_STONE = REGISTRY.register("recharge_tornado_stone", () -> new RechargeTornadoStoneMobEffect());
	public static final RegistryObject<MobEffect> OCEAN_MASTER = REGISTRY.register("ocean_master", () -> new OceanMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_OCEAN_STONE = REGISTRY.register("recharge_ocean_stone", () -> new RechargeOceanStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_GREENERY_STONE = REGISTRY.register("recharge_greenery_stone", () -> new RechargeGreeneryStoneMobEffect());
	public static final RegistryObject<MobEffect> ANIMALS_MASTER = REGISTRY.register("animals_master", () -> new AnimalsMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_ANIMALS_STONE = REGISTRY.register("recharge_animals_stone", () -> new RechargeAnimalsStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_METAL_STONE = REGISTRY.register("recharge_metal_stone", () -> new RechargeMetalStoneMobEffect());
	public static final RegistryObject<MobEffect> LIGHT_MASTER = REGISTRY.register("light_master", () -> new LightMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_LIGHT_STONE = REGISTRY.register("recharge_light_stone", () -> new RechargeLightStoneMobEffect());
	public static final RegistryObject<MobEffect> SHADOW_MASTER = REGISTRY.register("shadow_master", () -> new ShadowMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_SHADOW_STONE = REGISTRY.register("recharge_shadow_stone", () -> new RechargeShadowStoneMobEffect());
	public static final RegistryObject<MobEffect> VACUUM_MASTER = REGISTRY.register("vacuum_master", () -> new VacuumMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_VACUUM_STONE = REGISTRY.register("recharge_vacuum_stone", () -> new RechargeVacuumStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_MOON_STONE = REGISTRY.register("recharge_moon_stone", () -> new RechargeMoonStoneMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_CREATION_STONE = REGISTRY.register("recharge_creation_stone", () -> new RechargeCreationStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_DESTRUCTION_STONE = REGISTRY.register("recharge_destruction_stone", () -> new RechargeDestructionStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_SPACE_STONE = REGISTRY.register("recharge_space_stone", () -> new RechargeSpaceStoneMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_BLOOD_STONE = REGISTRY.register("recharge_blood_stone", () -> new RechargeBloodStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_TECHNOLOGY_STONE = REGISTRY.register("recharge_technology_stone", () -> new RechargeTechnologyStoneMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_TIME_STONE = REGISTRY.register("recharge_time_stone", () -> new RechargeTimeStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> ACCELERATION_TIME_EFFECT = REGISTRY.register("acceleration_time_effect", () -> new AccelerationTimeEffectMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_TELEPORTATION_STONE = REGISTRY.register("recharge_teleportation_stone", () -> new RechargeTeleportationStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_EXPLOSION_STONE = REGISTRY.register("recharge_explosion_stone", () -> new RechargeExplosionStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_AMBER_STONE = REGISTRY.register("recharge_amber_stone", () -> new RechargeAmberStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_BLUE_FLAME_STONE = REGISTRY.register("recharge_blue_flame_stone", () -> new RechargeBlueFlameStoneMobEffect());
	public static final RegistryObject<MobEffect> FOG = REGISTRY.register("fog", () -> new FogMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_MAGNET_STONE = REGISTRY.register("recharge_magnet_stone", () -> new RechargeMagnetStoneMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_MIST_STONE = REGISTRY.register("recharge_mist_stone", () -> new RechargeMistStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_SAND_STONE = REGISTRY.register("recharge_sand_stone", () -> new RechargeSandStoneMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_SPEED_STONE = REGISTRY.register("recharge_speed_stone", () -> new RechargeSpeedStoneMobEffect());
	public static final RegistryObject<MobEffect> SPEED_MASTER = REGISTRY.register("speed_master", () -> new SpeedMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_POISON_STONE = REGISTRY.register("recharge_poison_stone", () -> new RechargePoisonStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_MUSHROOMS_STONE = REGISTRY.register("recharge_mushrooms_stone", () -> new RechargeMushroomsStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_MERCURY_STONE = REGISTRY.register("recharge_mercury_stone", () -> new RechargeMercuryStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_MUSIC_STONE = REGISTRY.register("recharge_music_stone", () -> new RechargeMusicStoneMobEffect());
	public static final RegistryObject<MobEffect> PLAGUE_MASTER = REGISTRY.register("plague_master", () -> new PlagueMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_PLAGUE_STONE = REGISTRY.register("recharge_plague_stone", () -> new RechargePlagueStoneMobEffect());
	public static final RegistryObject<MobEffect> GRAVITY_MASTER = REGISTRY.register("gravity_master", () -> new GravityMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_GRAVITY_STONE = REGISTRY.register("recharge_gravity_stone", () -> new RechargeGravityStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_SPIRIT_STONE = REGISTRY.register("recharge_spirit_stone", () -> new RechargeSpiritStoneMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_AETHER_STONE = REGISTRY.register("recharge_aether_stone", () -> new RechargeAetherStoneMobEffect());
	public static final RegistryObject<MobEffect> AETHER_MASTER = REGISTRY.register("aether_master", () -> new AetherMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_SMOKE_STONE = REGISTRY.register("recharge_smoke_stone", () -> new RechargeSmokeStoneMobEffect());
	public static final RegistryObject<MobEffect> SMOKE_MASTER = REGISTRY.register("smoke_master", () -> new SmokeMasterMobEffect());
	public static final RegistryObject<MobEffect> RECHARGE_FORM_STONE = REGISTRY.register("recharge_form_stone", () -> new RechargeFormStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_GOLDEN_DUST_STONE = REGISTRY.register("recharge_golden_dust_stone", () -> new RechargeGoldenDustStoneMobEffect());
	...
	public static final RegistryObject<MobEffect> RECHARGE_MIND_STONE = REGISTRY.register("recharge_mind_stone", () -> new RechargeMindStoneMobEffect());
