...
public class PowerModMenus {
	...
	public static final RegistryObject<MenuType<CultivationGUIMenu>> CULTIVATION_GUI = REGISTRY.register("cultivation_gui", () -> IForgeMenuType.create(CultivationGUIMenu::new));
	public static final RegistryObject<MenuType<SpawnAnimalsGUIMenu>> SPAWN_ANIMALS_GUI = REGISTRY.register("spawn_animals_gui", () -> IForgeMenuType.create(SpawnAnimalsGUIMenu::new));
	public static final RegistryObject<MenuType<ChoiseMagicStoneGUIMenu>> CHOISE_MAGIC_STONE_GUI = REGISTRY.register("choise_magic_stone_gui", () -> IForgeMenuType.create(ChoiseMagicStoneGUIMenu::new));
	public static final RegistryObject<MenuType<ChoiseMagicStonesPage2Menu>> CHOISE_MAGIC_STONES_PAGE_2 = REGISTRY.register("choise_magic_stones_page_2", () -> IForgeMenuType.create(ChoiseMagicStonesPage2Menu::new));
	public static final RegistryObject<MenuType<CheckpointGUIMenu>> CHECKPOINT_GUI = REGISTRY.register("checkpoint_gui", () -> IForgeMenuType.create(CheckpointGUIMenu::new));
	public static final RegistryObject<MenuType<BatteryCreateGUIMenu>> BATTERY_CREATE_GUI = REGISTRY.register("battery_create_gui", () -> IForgeMenuType.create(BatteryCreateGUIMenu::new));
	public static final RegistryObject<MenuType<RedstoneBundleGUIMenu>> REDSTONE_BUNDLE_GUI = REGISTRY.register("redstone_bundle_gui", () -> IForgeMenuType.create(RedstoneBundleGUIMenu::new));
	public static final RegistryObject<MenuType<BuildingGUIMenu>> BUILDING_GUI = REGISTRY.register("building_gui", () -> IForgeMenuType.create(BuildingGUIMenu::new));
	...
	public static final RegistryObject<MenuType<EBEnergyMenu>> EB_ENERGY = REGISTRY.register("eb_energy", () -> IForgeMenuType.create(EBEnergyMenu::new));
	...
	public static final RegistryObject<MenuType<EBLightningMenu>> EB_LIGHTNING = REGISTRY.register("eb_lightning", () -> IForgeMenuType.create(EBLightningMenu::new));
	...
	public static final RegistryObject<MenuType<EBCrystalMenu>> EB_CRYSTAL = REGISTRY.register("eb_crystal", () -> IForgeMenuType.create(EBCrystalMenu::new));
	...
	public static final RegistryObject<MenuType<EBTornadoMenu>> EB_TORNADO = REGISTRY.register("eb_tornado", () -> IForgeMenuType.create(EBTornadoMenu::new));
	...
	public static final RegistryObject<MenuType<EBGreeneryMenu>> EB_GREENERY = REGISTRY.register("eb_greenery", () -> IForgeMenuType.create(EBGreeneryMenu::new));
	public static final RegistryObject<MenuType<EBAnimalsMenu>> EB_ANIMALS = REGISTRY.register("eb_animals", () -> IForgeMenuType.create(EBAnimalsMenu::new));
	...
	public static final RegistryObject<MenuType<EBShadowMenu>> EB_SHADOW = REGISTRY.register("eb_shadow", () -> IForgeMenuType.create(EBShadowMenu::new));
	public static final RegistryObject<MenuType<EBVacuumMenu>> EB_VACUUM = REGISTRY.register("eb_vacuum", () -> IForgeMenuType.create(EBVacuumMenu::new));
	...
	public static final RegistryObject<MenuType<EBCreationMenu>> EB_CREATION = REGISTRY.register("eb_creation", () -> IForgeMenuType.create(EBCreationMenu::new));
	public static final RegistryObject<MenuType<EBDestructionMenu>> EB_DESTRUCTION = REGISTRY.register("eb_destruction", () -> IForgeMenuType.create(EBDestructionMenu::new));
	...
	public static final RegistryObject<MenuType<EBTechnologyMenu>> EB_TECHNOLOGY = REGISTRY.register("eb_technology", () -> IForgeMenuType.create(EBTechnologyMenu::new));
	public static final RegistryObject<MenuType<EBTeleportationMenu>> EB_TELEPORTATION = REGISTRY.register("eb_teleportation", () -> IForgeMenuType.create(EBTeleportationMenu::new));
	public static final RegistryObject<MenuType<EBExplosionMenu>> EB_EXPLOSION = REGISTRY.register("eb_explosion", () -> IForgeMenuType.create(EBExplosionMenu::new));
	...
	public static final RegistryObject<MenuType<EBBlueFlameMenu>> EB_BLUE_FLAME = REGISTRY.register("eb_blue_flame", () -> IForgeMenuType.create(EBBlueFlameMenu::new));
	public static final RegistryObject<MenuType<ChoiseMagicStonesPage3Menu>> CHOISE_MAGIC_STONES_PAGE_3 = REGISTRY.register("choise_magic_stones_page_3", () -> IForgeMenuType.create(ChoiseMagicStonesPage3Menu::new));
	public static final RegistryObject<MenuType<SpaceAtlasGUIMenu>> SPACE_ATLAS_GUI = REGISTRY.register("space_atlas_gui", () -> IForgeMenuType.create(SpaceAtlasGUIMenu::new));
	public static final RegistryObject<MenuType<CheckPointTPMenu>> CHECK_POINT_TP = REGISTRY.register("check_point_tp", () -> IForgeMenuType.create(CheckPointTPMenu::new));
	public static final RegistryObject<MenuType<LevelsAndSkillsPageMenu>> LEVELS_AND_SKILLS_PAGE = REGISTRY.register("levels_and_skills_page", () -> IForgeMenuType.create(LevelsAndSkillsPageMenu::new));
	public static final RegistryObject<MenuType<BuyLevel2Menu>> BUY_LEVEL_2 = REGISTRY.register("buy_level_2", () -> IForgeMenuType.create(BuyLevel2Menu::new));
	public static final RegistryObject<MenuType<BuyLevel3Menu>> BUY_LEVEL_3 = REGISTRY.register("buy_level_3", () -> IForgeMenuType.create(BuyLevel3Menu::new));
	...
	public static final RegistryObject<MenuType<SoundImitateChoiceMenu>> SOUND_IMITATE_CHOICE = REGISTRY.register("sound_imitate_choice", () -> IForgeMenuType.create(SoundImitateChoiceMenu::new));
	...
	public static final RegistryObject<MenuType<EBPoisonMenu>> EB_POISON = REGISTRY.register("eb_poison", () -> IForgeMenuType.create(EBPoisonMenu::new));
	public static final RegistryObject<MenuType<EBMagnetMenu>> EB_MAGNET = REGISTRY.register("eb_magnet", () -> IForgeMenuType.create(EBMagnetMenu::new));
	public static final RegistryObject<MenuType<EBMushroomsMenu>> EB_MUSHROOMS = REGISTRY.register("eb_mushrooms", () -> IForgeMenuType.create(EBMushroomsMenu::new));
	public static final RegistryObject<MenuType<EBMercuryMenu>> EB_MERCURY = REGISTRY.register("eb_mercury", () -> IForgeMenuType.create(EBMercuryMenu::new));
	public static final RegistryObject<MenuType<MusicPlayerGUIMenu>> MUSIC_PLAYER_GUI = REGISTRY.register("music_player_gui", () -> IForgeMenuType.create(MusicPlayerGUIMenu::new));
	...
	public static final RegistryObject<MenuType<EBPlagueMenu>> EB_PLAGUE = REGISTRY.register("eb_plague", () -> IForgeMenuType.create(EBPlagueMenu::new));
	public static final RegistryObject<MenuType<RocketPathGUIMenu>> ROCKET_PATH_GUI = REGISTRY.register("rocket_path_gui", () -> IForgeMenuType.create(RocketPathGUIMenu::new));
	public static final RegistryObject<MenuType<EBGravityMenu>> EB_GRAVITY = REGISTRY.register("eb_gravity", () -> IForgeMenuType.create(EBGravityMenu::new));
	public static final RegistryObject<MenuType<CustomMusicPlayerMenu>> CUSTOM_MUSIC_PLAYER = REGISTRY.register("custom_music_player", () -> IForgeMenuType.create(CustomMusicPlayerMenu::new));
	public static final RegistryObject<MenuType<BuildInMusicPlayerMenu>> BUILD_IN_MUSIC_PLAYER = REGISTRY.register("build_in_music_player", () -> IForgeMenuType.create(BuildInMusicPlayerMenu::new));
	...
	public static final RegistryObject<MenuType<EBSpiritMenu>> EB_SPIRIT = REGISTRY.register("eb_spirit", () -> IForgeMenuType.create(EBSpiritMenu::new));
	public static final RegistryObject<MenuType<ChoiseMagicPower1Menu>> CHOISE_MAGIC_POWER_1 = REGISTRY.register("choise_magic_power_1", () -> IForgeMenuType.create(ChoiseMagicPower1Menu::new));
	public static final RegistryObject<MenuType<ChoiseMagicPower3Menu>> CHOISE_MAGIC_POWER_3 = REGISTRY.register("choise_magic_power_3", () -> IForgeMenuType.create(ChoiseMagicPower3Menu::new));
	public static final RegistryObject<MenuType<ChoiseMagicPower2Menu>> CHOISE_MAGIC_POWER_2 = REGISTRY.register("choise_magic_power_2", () -> IForgeMenuType.create(ChoiseMagicPower2Menu::new));
	public static final RegistryObject<MenuType<EBAetherMenu>> EB_AETHER = REGISTRY.register("eb_aether", () -> IForgeMenuType.create(EBAetherMenu::new));
	public static final RegistryObject<MenuType<CompanionsGuiMenu>> COMPANIONS_GUI = REGISTRY.register("companions_gui", () -> IForgeMenuType.create(CompanionsGuiMenu::new));
	...
	public static final RegistryObject<MenuType<EBGoldenDustMenu>> EB_GOLDEN_DUST = REGISTRY.register("eb_golden_dust", () -> IForgeMenuType.create(EBGoldenDustMenu::new));
	public static final RegistryObject<MenuType<BuyReactiveFlyingMenu>> BUY_REACTIVE_FLYING = REGISTRY.register("buy_reactive_flying", () -> IForgeMenuType.create(BuyReactiveFlyingMenu::new));
	public static final RegistryObject<MenuType<EBDarknessMenu>> EB_DARKNESS = REGISTRY.register("eb_darkness", () -> IForgeMenuType.create(EBDarknessMenu::new));
}
