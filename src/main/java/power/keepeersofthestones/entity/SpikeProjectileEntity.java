...
public class SpikeProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(PowerModItems.SPIKE.get());

	public SpikeProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(PowerModEntities.SPIKE_PROJECTILE.get(), world);
	}
	...
	public static SpikeProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		SpikeProjectileEntity entityarrow = new SpikeProjectileEntity(PowerModEntities.SPIKE_PROJECTILE.get(), entity, world);
	...
	public static SpikeProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		SpikeProjectileEntity entityarrow = new SpikeProjectileEntity(PowerModEntities.SPIKE_PROJECTILE.get(), entity, entity.level());
