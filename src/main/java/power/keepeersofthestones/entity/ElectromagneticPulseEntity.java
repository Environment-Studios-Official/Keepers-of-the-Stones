...
public class ElectromagneticPulseEntity extends AbstractArrow implements ItemSupplier {
	public ElectromagneticPulseEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(PowerModEntities.ELECTROMAGNETIC_PULSE.get(), world);
	}

	public ElectromagneticPulseEntity(EntityType<? extends ElectromagneticPulseEntity> type, Level world) {
		super(type, world);
	}

	public ElectromagneticPulseEntity(EntityType<? extends ElectromagneticPulseEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public ElectromagneticPulseEntity(EntityType<? extends ElectromagneticPulseEntity> type, LivingEntity entity, Level world) {
	...
	public ItemStack getItem() {
		return new ItemStack(PowerModItems.ELECTROMAGNETIC_PULSE.get());
	}
