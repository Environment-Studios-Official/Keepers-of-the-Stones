...
public class ShurikenProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(PowerModItems.SHURIKEN.get());

	public ShurikenProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(PowerModEntities.SHURIKEN_PROJECTILE.get(), world);
	}
	...
	public static ShurikenProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 0.8f, 10, 1);
	}
	...
	public static ShurikenProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		ShurikenProjectileEntity entityarrow = new ShurikenProjectileEntity(PowerModEntities.SHURIKEN_PROJECTILE.get(), entity, world);
	...
	public static ShurikenProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		ShurikenProjectileEntity entityarrow = new ShurikenProjectileEntity(PowerModEntities.SHURIKEN_PROJECTILE.get(), entity, entity.level());
