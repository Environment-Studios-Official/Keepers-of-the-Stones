...
public abstract class FireItem extends ArmorItem {
	public FireItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends FireItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "power:textures/models/armor/fire__layer_1.png";
		}
	}
	...
	public static class Leggings extends FireItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "power:textures/models/armor/fire__layer_2.png";
		}
	}
