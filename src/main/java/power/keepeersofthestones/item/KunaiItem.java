...
public class KunaiItem extends Item {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entity, int time) {
		if (!world.isClientSide() && entity instanceof ServerPlayer player) {
			ItemStack stack = ProjectileWeaponItem.getHeldProjectile(entity, e -> e.getItem() == KunaiProjectileEntity.PROJECTILE_ITEM.getItem());
			...
			if (player.getAbilities().instabuild || stack != ItemStack.EMPTY) {
				KunaiProjectileEntity projectile = KunaiProjectileEntity.shoot(world, entity, world.getRandom());
