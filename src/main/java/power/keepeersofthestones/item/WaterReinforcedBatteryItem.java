...
public class WaterReinforcedBatteryItem extends Item {
	public WaterReinforcedBatteryItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal(WaterBTProcedure.execute()));
	}

	@Override
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		InteractionResultHolder<ItemStack> ar = super.use(world, entity, hand);
		WaterReinforcedBatteryUseProcedure.execute(world, entity, ar.getObject());
		return ar;
	}
}
