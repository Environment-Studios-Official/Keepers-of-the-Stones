...
public class IsolationEnchantment extends Enchantment {
	...
	protected boolean checkCompatibility(Enchantment ench) {
		return List.of(Enchantments.SHARPNESS, Enchantments.SMITE, Enchantments.BANE_OF_ARTHROPODS, Enchantments.KNOCKBACK, Enchantments.SWEEPING_EDGE, Enchantments.FIRE_ASPECT, Enchantments.MOB_LOOTING, Enchantments.MENDING, Enchantments.UNBREAKING,
