...
public class LevelsAndSkillsPageButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(LevelsAndSkillsPageButtonMessage.class, LevelsAndSkillsPageButtonMessage::buffer, LevelsAndSkillsPageButtonMessage::new, LevelsAndSkillsPageButtonMessage::handler);
	}
}
