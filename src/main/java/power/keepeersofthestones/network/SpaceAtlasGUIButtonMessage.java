...
public class SpaceAtlasGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(SpaceAtlasGUIButtonMessage.class, SpaceAtlasGUIButtonMessage::buffer, SpaceAtlasGUIButtonMessage::new, SpaceAtlasGUIButtonMessage::handler);
	}
}
