...
public class BuyReactiveFlyingButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(BuyReactiveFlyingButtonMessage.class, BuyReactiveFlyingButtonMessage::buffer, BuyReactiveFlyingButtonMessage::new, BuyReactiveFlyingButtonMessage::handler);
	}
}
