...
public class MusicPlayerGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(MusicPlayerGUIButtonMessage.class, MusicPlayerGUIButtonMessage::buffer, MusicPlayerGUIButtonMessage::new, MusicPlayerGUIButtonMessage::handler);
	}
}
