...
public class RainBowProjectileRenderer extends EntityRenderer<RainBowProjectileEntity> {
	...
	public RainBowProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelmagic_arrow(context.bakeLayer(Modelmagic_arrow.LAYER_LOCATION));
	}

	@Override
	public void render(RainBowProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(RainBowProjectileEntity entity) {
		return texture;
	}
}
