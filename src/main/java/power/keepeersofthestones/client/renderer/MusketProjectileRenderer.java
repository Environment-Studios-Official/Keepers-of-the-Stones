...
public class MusketProjectileRenderer extends EntityRenderer<MusketProjectileEntity> {
	...
	public MusketProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelmagic_arrow(context.bakeLayer(Modelmagic_arrow.LAYER_LOCATION));
	}

	@Override
	public void render(MusketProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(MusketProjectileEntity entity) {
		return texture;
	}
}
