...
public class TornadoCreateRenderer extends EntityRenderer<TornadoCreateEntity> {
	...
	@Override
	public void render(TornadoCreateEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(TornadoCreateEntity entity) {
		return texture;
	}
}
