...
public class GoldenCrossbowRenderer extends EntityRenderer<GoldenCrossbowEntity> {
	...
	public GoldenCrossbowRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelmagic_arrow(context.bakeLayer(Modelmagic_arrow.LAYER_LOCATION));
	}

	@Override
	public void render(GoldenCrossbowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(GoldenCrossbowEntity entity) {
		return texture;
	}
}
