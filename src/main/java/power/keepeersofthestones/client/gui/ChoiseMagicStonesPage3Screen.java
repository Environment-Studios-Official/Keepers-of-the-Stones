...
public class ChoiseMagicStonesPage3Screen extends AbstractContainerScreen<ChoiseMagicStonesPage3Menu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("power:textures/screens/golden_dust_master.png"), this.leftPos + 109, this.topPos + 60, 0, 0, 16, 16, 16, 16);
		...
		guiGraphics.blit(new ResourceLocation("power:textures/screens/darkness_master.png"), this.leftPos + 109, this.topPos + 87, 0, 0, 16, 16, 16, 16);
