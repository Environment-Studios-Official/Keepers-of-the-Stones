...
public class EBEarthScreen extends AbstractContainerScreen<EBEarthMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("power:textures/screens/earth_stone.png"), this.leftPos + -105, this.topPos + -109, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_earth.label_class_basic"), -163, -85, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_earth.label_element_earth"), -163, -67, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_earth.label_force_resistance"), -163, -49, -12829636, false);
	}
