...
public class ChoiseMagicPower2Screen extends AbstractContainerScreen<ChoiseMagicPower2Menu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("power:textures/screens/gravity_master.png"), this.leftPos + 109, this.topPos + 141, 0, 0, 16, 16, 16, 16);
	...
	public void init() {
		super.init();
		button_moon = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_moon"), e -> {
			if (true) {
		...
		button_destruct = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_destruct"), e -> {
			if (true) {
		...
		button_space = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_space"), e -> {
			if (true) {
		...
		button_blood = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_blood"), e -> {
			if (true) {
		...
		button_time = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_time"), e -> {
			if (true) {
		...
		button_techolog = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_techolog"), e -> {
			if (true) {
		...
		button_explosion = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_explosion"), e -> {
			if (true) {
		...
		button_teleport = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_teleport"), e -> {
			if (true) {
		...
		button_creation = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_creation"), e -> {
			if (true) {
		...
		button_mist = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_mist"), e -> {
			if (true) {
		...
		button_sand = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_sand"), e -> {
			if (true) {
		...
		button_speed = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_speed"), e -> {
			if (true) {
		...
		button_previous_page = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_previous_page"), e -> {
			if (true) {
		...
		button_poison = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_poison"), e -> {
			if (true) {
		...
		button_magnet = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_magnet"), e -> {
			if (true) {
		...
		button_mushrooms = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_mushrooms"), e -> {
			if (true) {
		...
		button_mercury = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_mercury"), e -> {
			if (true) {
		...
		button_music = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_music"), e -> {
			if (true) {
		...
		button_plague = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_plague"), e -> {
			if (true) {
		...
		button_gravity = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_gravity"), e -> {
			if (true) {
		...
		button_next_page = Button.builder(Component.translatable("gui.power.choise_magic_power_2.button_next_page"), e -> {
			if (true) {
