...
public class EBOceanScreen extends AbstractContainerScreen<EBOceanMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("power:textures/screens/ocean_stone.png"), this.leftPos + -104, this.topPos + -109, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_ocean.label_class_additional"), -162, -85, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_ocean.label_element_ocean"), -162, -67, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_ocean.label_force_deepness"), -162, -49, -12829636, false);
	}
