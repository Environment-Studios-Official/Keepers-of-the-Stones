...
public class EBAetherScreen extends AbstractContainerScreen<EBAetherMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("power:textures/screens/aether_stone.png"), this.leftPos + -104, this.topPos + -109, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_aether.label_class_basic"), -162, -85, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_aether.label_element_aether"), -162, -67, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_aether.label_force_quintessence"), -162, -49, -12829636, false);
	}
