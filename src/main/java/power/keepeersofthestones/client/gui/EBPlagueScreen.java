...
public class EBPlagueScreen extends AbstractContainerScreen<EBPlagueMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("power:textures/screens/plague_element.png"), this.leftPos + 71, this.topPos + -85, 0, 0, 53, 128, 53, 128);
	...
	public void init() {
		super.init();
		button_empty = Button.builder(Component.translatable("gui.power.eb_plague.button_empty"), e -> {
			if (true) {
