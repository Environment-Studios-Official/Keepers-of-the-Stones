...
public class CustomMusicPlayerScreen extends AbstractContainerScreen<CustomMusicPlayerMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.power.custom_music_player.label_music_player"), 160, 7, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.power.custom_music_player.label_this_music_works_only_with_a_res"), 25, 142, -65536, false);
	}
