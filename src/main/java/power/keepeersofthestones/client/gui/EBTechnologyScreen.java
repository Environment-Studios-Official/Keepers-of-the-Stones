...
public class EBTechnologyScreen extends AbstractContainerScreen<EBTechnologyMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("power:textures/screens/technology_stone.png"), this.leftPos + -105, this.topPos + -109, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_technology.label_class_middle"), -163, -85, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_technology.label_element_technology"), -163, -67, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.power.eb_technology.label_force_control"), -163, -49, -12829636, false);
	}
