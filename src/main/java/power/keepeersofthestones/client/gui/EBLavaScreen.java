...
public class EBLavaScreen extends AbstractContainerScreen<EBLavaMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("power:textures/screens/lava_element.png"), this.leftPos + 71, this.topPos + -85, 0, 0, 61, 128, 61, 128);
	...
	public void init() {
		super.init();
		button_empty = Button.builder(Component.translatable("gui.power.eb_lava.button_empty"), e -> {
			if (true) {
